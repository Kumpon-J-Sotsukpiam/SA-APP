      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <View style={styles.container}>
          ...
          <View style={{backgroundColor:'#fd4176',height:300,paddingBottom:30,alignItems: 'center',justifyContent:'flex-end'}}>
                ...
                <Text style={{color:'#fff',fontSize:25}}>{this.state.studentID}</Text>
                <Text style={{color:'#fff',fontSize:25,marginBottom:10}}>{this.state.studentName}</Text>
                <Text style={{color:'#fff',fontSize:16}}>• {this.state.faculty}</Text>
                <Text style={{color:'#fff',fontSize:16}}>• {this.state.major}</Text>
          </View>
...
export default Student_ProfileScreen